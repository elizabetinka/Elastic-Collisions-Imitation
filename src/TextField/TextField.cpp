...
void TextField::setFont(sf::Font& f) {
    ...
    box.setSize(sf::Vector2f((txt.getCharacterSize()*(size/2+1))+1, txt.getCharacterSize()+4));
}
...
void TextField::setLength(int arg) {
    ...
    box.setSize(sf::Vector2f((txt.getCharacterSize()*(size/2+1))+1, txt.getCharacterSize()+10));
}
