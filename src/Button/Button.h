...
#define FONT_PATH /Users/indo.evri.momint/PhysicsModel1/src/fonts/Raleway-Light.ttf
...
namespace sf
{
    ...
    private:
        ...
        sf::Vector2f size;
        sf::Color color[2] = {sf::Color::Green, sf::Color::Red};
        int cur_color = 0;
    ...
    public:
        ...
        void setOnClickListener2(std::function<void()> callback);
